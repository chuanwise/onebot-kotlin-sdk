...
fun <T> JsonNode.deserializeTo(typeReference: TypeReference<T>) = objectMapper.convertValue(this, typeReference)

inline fun <reified T> JsonNode.deserializeTo() = deserializeTo(object : TypeReference<T>() {})
