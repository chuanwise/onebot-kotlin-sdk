...
class OneBot11Action<P, R>(
    ...
    companion object {
        ...
        val DELETE_MESSAGE = OneBot11Action<MessageIDData, Unit>("delete_msg")
        ...
        val SEND_LIKE = OneBot11Action<SendLikeData, Unit>("send_like")

        // https://github.com/botuniverse/onebot-11/blob/master/api/public.md#set_group_kick-%E7%BE%A4%E7%BB%84%E8%B8%A2%E4%BA%BA
        val SET_GROUP_KICK = OneBot11Action<SetGroupKickData, Unit>("set_group_kick")
        ...
        val SET_GROUP_BAN = OneBot11Action<SetGroupBanData, Unit>("set_group_ban")
        ...
        val SET_GROUP_ANONYMOUS_BAN = OneBot11Action<SetGroupAnonymousBanData, Unit>("set_group_anonymous_ban")
        ...
        val SET_GROUP_WHOLE_BAN = OneBot11Action<GroupIDEnableData, Unit>("set_group_whole_ban")
        ...
        val SET_GROUP_ADMIN = OneBot11Action<GroupIDUserIDEnableData, Unit>("set_group_admin")

        // https://github.com/botuniverse/onebot-11/blob/master/api/public.md#set_group_anonymous-%E7%BE%A4%E7%BB%84%E5%8C%BF%E5%90%8D
        val SET_GROUP_ANONYMOUS = OneBot11Action<GroupIDEnableData, Unit>("set_group_anonymous")
        ...
        val SET_GROUP_SPECIAL_TITLE = OneBot11Action<SetGroupSpecialTitleData, Unit>("set_group_special_title")
        ...
        val SET_FRIEND_ADD_REQUEST = OneBot11Action<SetFriendAddRequestData, Unit>("set_friend_add_request")
        ...
        val SET_GROUP_ADD_REQUEST = OneBot11Action<SetGroupAddRequestData, Unit>("set_group_add_request")
        ...
        val GET_LOGIN_INFO = OneBot11Action<Unit, GetLoginInfoData>("get_login_info")
        ...
        val GET_FRIEND_LIST = OneBot11Action<Unit, List<FriendListElement>>("get_friend_list")
        ...
        val GET_GROUP_LIST = OneBot11Action<Unit, List<GetGroupInfoResponseData>>("get_group_list")
        ...
        val GET_CSRF_TOKEN = OneBot11Action<Unit, GetCSRFTokenData>("get_csrf_token")
        ...
        val CAN_SEND_IMAGE = OneBot11Action<Unit, YesOrNoData>("can_send_image")
        ...
        val CAN_SEND_RECORD = OneBot11Action<Unit, YesOrNoData>("can_send_record")
        ...
        val GET_STATUS = OneBot11Action<Unit, Map<*, *>>("get_status")
        ...
        val HIDDEN_HANDLE_QUICK_OPERATION = OneBot11Action<HandleQuickOperationData, Unit>("handle_quick_operation")
    }
}
